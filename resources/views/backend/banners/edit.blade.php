                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.banners.update', $banner) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ $banner->title }}" class="w-full p-2 border rounded-lg" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order" id="order" value="{{ $banner->order }}" class="w-full p-2 border rounded-lg" required>
                        </div>
