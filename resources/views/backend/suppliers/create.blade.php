                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.suppliers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" id="address" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="inline-flex products-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:ring focus:ring-indigo-200 disabled:opacity-25 transition">
                                {{ __('Create') }}
                            </button>
                        </div>
                    </form>
