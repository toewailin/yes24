...
<html lang="{{ $page->language ?? 'en' }}">
    ...
    <body>
        <div class="flex justify-center products-center h-screen bg-gray-200 px-6">
            <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
                <div class="flex justify-center products-center">
                ...
                <form class="mt-4" action="/" method="GET">
                    ...
                    <div class="flex justify-between products-center mt-4">
                        <div>
