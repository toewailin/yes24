    ...
    <div class="mt-4">
        ...
        <div class="mt-4">
            <div class="max-w-sm w-full bg-white shadow-md rounded-md overflow-hidden border">
                <form>
                    <div class="flex justify-between products-center px-5 py-3 text-gray-700 border-b">
                    ...
                    <div class="px-5 py-6 bg-gray-200 text-gray-700 border-b">
                        ...
                        <div class="mt-2 relative rounded-md shadow-sm">
                            <span class="absolute inset-y-0 left-0 pl-3 flex products-center text-gray-600">
                    ...
                    <div class="flex justify-between products-center px-5 py-3">
